#' Estimate if your file contain rain and insects for 10 min intervals
#
#' @param evaluation10 Estimates a evaluation of insect and rain
#' @import tuneR
#' @import seewave
#' @import soundecology
#' @import vegan
...
#' #evaluation10()->evaluation10min #Vector that contain your results
#' #evaluation10min #Call the vector, and see your results.
#'
#'
#'
...
evaluation10 <- function(){

  df <- data.frame()

  files <- list.files(path = getwd(), pattern = "wav$", ignore.case = T )
  minutos<-seq(0:9)# 60-minute interval

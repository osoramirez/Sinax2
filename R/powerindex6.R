...
#' @param powerindex6 Estimates the power spectral analysis of your sound file in dB by frequency of 1kHz.
#' @usage powerindex6()
#' @return return a table with a different power spectral index
#' @export
#' @examples
#' #This code analyzes for a 6-minutes intervals
#' #powerindex6()->powerindex6min #Vector that contain your results
#' #powerindex6min #Call the vector, and see your results.
#'
#'

#' Estimate if your file contain rain and insects for 6 min intervals
#
#' @param evaluation6 Estimates a evaluation of insect and rain
#' @import tuneR
#' @import seewave
#' @import soundecology
#' @import vegan
...
#' @export
#' @examples
#' #This code analyzes for a 6-minute interval
#' #evaluation6()->evaluation6min #Vector that contain your results
#' #evaluation6min #Call the vector, and see your results.
#'
#'
...
evaluation6 <- function(){

  df <- data.frame()

  files <- list.files(path = getwd(), pattern = "wav$", ignore.case = T )
  minutos<-seq(0:5)# 60-minute interval

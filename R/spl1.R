#' Sound pressure level at 1 min interval

#' @param spl1 Sound pressure level uses a logarithmic scale to represent the sound pressure of a sound relative to a reference pressure
#' @usage spl1
#' @import tuneR
#' @import seewave
#' @import data.table
...
#' #spl1()->spl1min #Vector that contain your results
#' #spl1min #Call the vector, and see your results.
#'
